...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', default='model_name not set', type=str)
    ...
    print(f"{opt.model_name}: This model adds ReduceLROnPlateau & compute_class_weight on each batch")
