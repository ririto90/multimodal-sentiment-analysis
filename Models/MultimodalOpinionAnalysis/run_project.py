    ...
    def train(train_loader, validation_loader, test_loader, params, device):
        ...
        for epoch in range(params.epochs):
            ...
            if acc_test > best_test_accuracy:
                ...
                torch.save(model, os.path.join('/home/rgg2706/Multimodal-Sentiment-Analysis/Models/MultimodalOpinionAnalysis/SaveFiles/SentimentClassifier', 'model10_{:.0f}_{:.0f}'.format(acc_test * 100, f1_pn * 100 )))
