...
class MVSADatasetReader:
    ...
    def __init__(self, transform, paths=DATASET_PATHS, path_image=IMAGE_PATH, dataset='mvsa-mts', max_seq_len=40):
        ...
        val_data, val_classes, val_lengths = MVSADatasetReader.__read_data__(val_path, tokenizer, transform, max_seq_len, path_image)
        ...
        test_data, test_classes, test_lengths = MVSADatasetReader.__read_data__(test_path, tokenizer, transform, max_seq_len, path_image)
